...
<!-- .slide: data-menu-title="Historie Toegankelijk Groningenda" data-background-image="images/history.png" data-background-opacity="0.2" -->
...
<!-- .slide: data-menu-title="Start Werkgroep Toegankelijk Groningen" data-background-image="images/StartWerkgroep.jpg" data-background-opacity="0.2" -->
...
- 'Onafhankelijk' van de gemeente!              <!-- .element: class="fragment" data-fragment-index="6" -->
